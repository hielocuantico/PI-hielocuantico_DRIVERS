const LogoDrivers = () => {
    return <svg
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="120px" height="30px" viewBox="0 0 120 30" version="1.1" className="injected-svg js-svg-inject">
                ...
                <g id="Logos- /-F1-logo-red" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="Page-1">
                        <mask id="mask-2" fill="white">
                            <use xlinkHref="#path-1"></use>
                        </mask>
                        <use id="Fill-1" fill="#EE0000" xlinkHref="#path-1"></use>
                    </g>
                </g>
            </svg>
        </svg>
